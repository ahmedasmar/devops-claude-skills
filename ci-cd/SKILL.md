...
|--------|---------|-------|
| `pipeline_analyzer.py` | Find optimization opportunities (caching, parallelization, outdated actions) | `python3 scripts/pipeline_analyzer.py --platform github --workflow .github/workflows/ci.yml` |
...
All templates include security scanning, caching, and multi-environment deployment stages.
